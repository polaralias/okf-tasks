...
description: Detailed dummy architecture document for security architecture.
status: current
...
This document defines the responsibilities, trust boundaries, and collaboration model for security architecture. It is intentionally detailed enough to exercise the Reader while remaining connected to the wider decision graph.
...
- [ADR 018: Migration Dual Read Window](../decisions/adr-018-migration-dual-read-window.md)
