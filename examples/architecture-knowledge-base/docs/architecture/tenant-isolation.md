...
description: Detailed dummy architecture document for tenant isolation.
status: current
...
This document defines the responsibilities, trust boundaries, and collaboration model for tenant isolation. It is intentionally detailed enough to exercise the Reader while remaining connected to the wider decision graph.
