...
description: Detailed dummy architecture document for container topology.
status: current
...
This document defines the responsibilities, trust boundaries, and collaboration model for container topology. It is intentionally detailed enough to exercise the Reader while remaining connected to the wider decision graph.
