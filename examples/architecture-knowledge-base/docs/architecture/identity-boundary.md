...
description: Detailed dummy architecture document for identity boundary.
status: current
...
This document defines the responsibilities, trust boundaries, and collaboration model for identity boundary. It is intentionally detailed enough to exercise the Reader while remaining connected to the wider decision graph.
...
- [ADR 004: Tenant Key Partitioning](../decisions/adr-004-tenant-key-partitioning.md)
