...
description: Detailed dummy architecture document for event backbone.
status: current
...
This document defines the responsibilities, trust boundaries, and collaboration model for event backbone. It is intentionally detailed enough to exercise the Reader while remaining connected to the wider decision graph.
