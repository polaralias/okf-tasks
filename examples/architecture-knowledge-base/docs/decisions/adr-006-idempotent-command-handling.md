...
title: 'Adr 006: Idempotent Command Handling'
description: 'Detailed dummy architecture decision for adr 006: idempotent command
  handling.'
status: accepted
...
# ADR 006: Idempotent Command Handling

## Context

The platform needs an explicit and reviewable choice for idempotent command handling. The decision affects service ownership, failure recovery, and the shape of evidence retained by delivery tasks.
...
- [Previous decision: Transactional Outbox](./adr-005-transactional-outbox.md)
