...
title: 'Adr 001: Modular Service Boundaries'
description: 'Detailed dummy architecture decision for adr 001: modular service boundaries.'
status: accepted
...
# ADR 001: Modular Service Boundaries

## Context

The platform needs an explicit and reviewable choice for modular service boundaries. The decision affects service ownership, failure recovery, and the shape of evidence retained by delivery tasks.
...
- This is the root decision in the example chain.
